...
elif [[ -f "/opt/gitstatus/gitstatus.plugin.sh" ]]; then
  source "/opt/gitstatus/gitstatus.plugin.sh" || return
else
...
#   08:35:29 [0] $ █
PS1='\[\033[38;5;180m\]\u\[\033[00m\]\[\033[38;5;244m\]@\[\033[00m\]\[\033[38;5;72m\]\h\[\033[00m\]'  # user@host
PS1+='\[\033[38;5;252m\]:\[\033[00m\]\[\033[38;5;111m\]\w\[\033[00m\]'                # current working directory
PS1+='${GITSTATUS_PROMPT:+ $GITSTATUS_PROMPT}'                          # git status (requires promptvars option)
PS1+='\n\[\033[38;5;8m\]\t\[\033[00m\] \[\033[00;$((33+!\j))m\][\j]\[\033[00m\] '          # new line, time, jobs
PS1+='\[\033[00;$((31+!$?))m\]\$\[\033[00m\] '                        # green/red (success/error) $/# (user/root)
